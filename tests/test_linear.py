...
def test_linear_shape():
    """Test that Linear produces the correct output shape."""
    batch_size = 4
    seq_len = 16
    in_features = 32
    out_features = 64
...
def test_linear_matches_pytorch():
    """Test forward correctness against torch.nn.Linear."""
...
def test_linear_backward():
    """Test backward gradients against torch.nn.Linear."""
    torch.manual_seed(42)
    ...
    # Use the same upstream gradient
...
def test_linear_dtype():
    """Test that Linear preserves the input dtype."""
...
def test_linear_parameter():
    """Test that weight is a trainable parameter."""
    layer = Linear(
        in_features=32,
        out_features=64,
    )
