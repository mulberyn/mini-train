"""Benchmark the naive KV cache alone (docs/kv_cache.md 三/五).

Run:
    python -m benchmark.kv_cache.benchmark_naive [--device cpu|cuda]
"""
...
def main():
    ...
    print_benchmark_header("Naive KV Cache")
